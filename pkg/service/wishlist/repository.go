...
func (r *repository) CreateWishList(input *wishdto.CreateWishListReq, contexts ...*fiber.Ctx) (*entities.WishList, error) {
	c, err := util.ContextParser(contexts...)
	if err != nil {
		return nil, err
	}
...
func (r *repository) GetWishList(id int, contexts ...*fiber.Ctx) (*entities.WishList, error) {
	c, err := util.ContextParser(contexts...)
	if err != nil {
		return nil, err
	}
...
func (r *repository) UpdateWishList(input *wishdto.UpdateWishListReq, id int, contexts ...*fiber.Ctx) (*entities.WishList, error) {
	c, err := util.ContextParser(contexts...)
	if err != nil {
		return nil, err
	}
...
func (r *repository) GetWishLists(contexts ...*fiber.Ctx) (*[]entities.WishList, error) {
	c, err := util.ContextParser(contexts...)
	if err != nil {
		return nil, err
	}
