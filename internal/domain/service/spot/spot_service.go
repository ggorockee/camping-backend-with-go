...
func (s *spotService) UpdateSpot(input *spotdto.UpdateSpotReq, id int, context ...*fiber.Ctx) (*entity.Spot, error) {
	return s.spotRepo.UpdateSpot(input, id, context...)
}

func (s *spotService) GetSpotById(id int, context ...*fiber.Ctx) (*entity.Spot, error) {
	return s.spotRepo.GetSpotById(id, context...)
}

func (s *spotService) DeleteSpot(id int, context ...*fiber.Ctx) error {
